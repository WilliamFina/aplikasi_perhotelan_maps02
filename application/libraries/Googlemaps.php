...
class Googlemaps
{
	...
	var $apiKey						= 'AIzaSyA9CASihanCphq2R0nIAHMU1jpA_I9X2rk'; 						// If you've got an API key you can use it by passing this parameter. Setup an API key here: https://code.google.com/apis/console
