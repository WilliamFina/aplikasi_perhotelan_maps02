...
class Googlemaps
{
	...
	var $apiKey						= 'AIzaSyDV9YBjpxYb9F6hcbGD-XPNrI9XNtlERbE'; 						// If you've got an API key you can use it by passing this parameter. Setup an API key here: https://code.google.com/apis/console
